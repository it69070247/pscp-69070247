...
```text
โจทย์ให้หาว่ากบกระโดดไปกี่ครั้งจนถึงที่หมาย

Input:
จำนวนเต็ม 2 ค่าในบรรทัดเดียว

Output:
จำนวนที่กบกระโดด หรือถ้าไม่ถึงprint-1

Constraints:
input อยู่ในบรรทัดเดียวกัน
```
...
```text
Step 1: รับค่าแล้ว split
Step 2: สร้างตัวแปลระยะกระโดด ระยะที่กระโดด และ นับก้าว
Step 3: while loop นับก้าว
Step 4: สร้างเงื่อนไข
Step 5: ถ้าถึงprintจำนวนครั้งที่กระโดด ถ้าไม่ถึงprint-1
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้ากระโดดไม่ถึง
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้ากระโดดหลายครั้ง
```
