...
| OJ submission ID, if submitted | 601983 |
| OJ status | Pass |
...
```text
เราสามารถคำนวณหากำแพงที่สุดยังไงได้บ้าง
```
...
```text
ให้หาชั้นของห้องแล้วสังเกตุห้องสามเหลี่ยมย่อย
```
...
```text
ฉันสังเกตุห้องสามเหลี่ยมย่อยว่ามันแตกต่างกันและกำแพงที่ต้องพังก็ต่างกัน
```
...
```text
ฉันได้ใช้สูตรคณิตในการคิดมากขึ้นและได้เรียนรู้การอ่านโจทย์ให้ละเอียดและหาpatternของโจทย์ที่ซับซ้อน
```
