...
```text
โจทย์ให้หากำแพงที่ต้องพังที่น้อยที่สุด

Input:
รับค่า n เป็นห้องในปราสาท

Output:
กำแพงที่ต้องพังที่น้อยที่สุด
...
```text
Step 1: รับค่า n
Step 2: หาชั้นของห้อง
Step 3: หาว่าห้องที่เราอยู่เป็นสามเหลี่ยมแบบไหน
Step 4: คำนวนกำแพงที่น้อยที่สุด
Step 5: printกำแพงที่น้อยที่สุด
```
...
```text
checkว่าโปรแกรมทำงานถูกต้องหรือไม่
```
...
```text
checkห้องที่เป็นสามเหลี่ยมคว่ำ
```
