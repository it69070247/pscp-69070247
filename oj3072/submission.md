...
```text
โจทย์ให้ฉันอ่านข้อความแล้วนับสระ
...
Step 2: สร้างตัวแปล COUNT ไว้นับ
Step 3: for loop นับสระ
Step 4: ถ้าCOUNT ไม่เป็น0 print สระ : จำนวนสระ
```
...
```text
check ว่าทำงานภูกต้องมั้ยถ้าไม่มีสระเลย
```
...
```text
check ว่าเปลี่ยนเป็นตัวพิมพ์เล็กให้มั้ย
```
