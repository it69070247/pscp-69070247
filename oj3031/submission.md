...
```text
โจทย์ให้ฉันหาเวลาที่หมึกจะท่วมบ้านของแต่ละคน

Input:
จำนวนเต็ม และ จำคนที่เรียกร้อง

Output:
เวลาที่หมึกจะท่วมบ้านของแต่ละคน
...
Step 1: รับค่าn
Step 2: split input
Step 3: for loop รับค่าพิกัดบ้าน
Step 4: คำนวณเวลา
Step 5: printเวลา
```
...
```text
check ว่าโปรแกรมทำงานถููกต้องมั้ย
```
