...
| OJ submission ID, if submitted | 601906 |
| OJ status | Pass |
...
```text
เราสามารถคำนวณหาเวลายังไงได้บ้าง
```
...
```text
ใช้พิกัดบ้านเป็นr แล้วเอามาคำนวณกับพื้นที่วงกลมหมึก
```
...
```text
ได้ใช้สูตรคณิตมากขึ้นได้เอา loop if math มาใช้ร่วมกัน
```
