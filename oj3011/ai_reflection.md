...
| OJ submission ID, if submitted | 555729 |
| OJ status | Pass |
...
```text
ฉันถาม Ai ว่าทำไมบาง testcase ถึงไม่ผ่าน มีtestcaseไหนที่codeของฉันใช้ไม่ได้
```
...
```text
ช่วยให้ดูตรงเงื่อนไขว่ามันยังไม่ละเอียดหากมีinputไหนที่เป็นแม่สีแค่ก็ยัง print Error
```
...
```text
ฉันกลับไปดูที่ elif ในOJอีกครั้งและเห็นว่า เงื่อนไขยังไม่ละเอียดเลยเพิ่มเงื่อนไขและสร้าง list แม่สี
```
...
```text
ฉันได้เรียนรู้ว่า list ก็ช่วยให้การทำหลายๆเงื่อนไขสะดวกขึ้นและการตั้งเงื่อนไขให้ละเอียดก็สำคัญ
```
