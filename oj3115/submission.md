...
```text
โจทย์ให้ฉันหาว่ามีร้านที่เปินในเวลาที่กำหนดกี่ร้าน

Input:
บรรทัด1 จํานวนเต็ม 2 ค่า จํานวนร้าน และ จํานวนช่วงเวลา
บรรทัดถัดไป n บรรทัด : เวลาเปิด ปิดของแต่ละร้าน
บรรทัดสุดท้าย เวลาที่ต้องการตรวจสอบ

Output:
บรรทัด1 คำตอบของแต่ละช่วงเวลา

Constraints:
คำตอบอยู่ในบรรทัดเดียวกันขั้นด้วย ช่องว่าง
```
...
```text
Step 1: รับค่า
Step 2: สร้าง list เวลาเปิดปิดและ list นับร้าน
Step 3: for loop รับเวลา
Step 4: เก็บเวลาเปิดปิดไว้ใน list
Step 5: รับเวลาที่จะcheck
Step 6: ตั้งเงื่อนไขถ้าเปิดก็ร้านหลักที่ n ในlistนับร้าน +1
Step 7: สร้างตัวแปรแปลงlistเป็น str
Step 8: print คำตอบ
```
...
```text
Chckว่าทำงานถูกต้องมั้ยถ้าใส่เวลาซ้ำ
```
...
```text
Chckว่าทำงานถูกต้องมั้ยถ้าเวลาเกิน 1440 นาที
```
