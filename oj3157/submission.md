...
```text
โจทย์ให้ฉันนับคะแนนจาก input ที่เป็น + -

Input:
บรรทัดแรก จํานวนเต็ม N
บรรทัดที่สอง ถึง N บรรทัด มี N คําสั่งเป็น + , -

Output:
คะแนนรวม

Constraints:
input เป็นเครื่องหมาย
```
...
```text
Step 1: รับค่าN
Step 2: for loop N ครั้ง
Step 3: รับ + -
Step 4: ตั้งเงื่อนไขนับแต้ม
Step 5: print แต้ม
```
...
```text
check ว่าทำงานถูกต้องมั้ย ถ้าเป็น + หมด
```
