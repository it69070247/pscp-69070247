...
```text
โจทย์ให้ฉันสร้างกรอบมาครอบ input ที่ใส่เข้ามา

Input:
เป็น str 5 บรรทัด

Output:
เป็นข้อความ5บรรทัดที่มี * เป็นกรอบสี่เหลี่ยม

Constraints:
input เป็น str กรอบ4เหลี่ยมจะมีเว้นวรรคขั้นระหว่างข้อความกับกรอบ
```
...
```text
Step 1: สร้าง list เก็บข้อความ และ list ไว้หาข้อความที่ยาวที่สุด
Step 2: for loop รับ input
Step 3: หาข้อความที่ยาวที่สุด
Step 4: for loop in range(7)
Step 5: สร้างtextเปล่า สำหรับใส่ข้อความ
Step 6: for loop อีกรอบเพื่อสร้างกรอบ
Step 7: ตั้งเงื่อนไขถ้าเป็นกรอบบนล่างให้ใส่ * ตามจำนวนตัวอักษรของข้อความที่ยาวที่สุด + 4
Step 8: ที่เหลือให้ใส่ * แล้วก็ข้อความโดยขั้นด้วยเว้นวรรค
```
...
```text
Step 1: สร้าง list เก็บข้อความ และ list ไว้หาข้อความที่ยาวที่สุด
Step 2: for loop รับ input โดยมี .strip()
Step 3: หาข้อความที่ยาวที่สุด
Step 4: for loop in range(7)
Step 5: สร้างtextเปล่า สำหรับใส่ข้อความ
Step 6: for loop อีกรอบเพื่อสร้างกรอบ
...
```text
check ว่าทำงานถูกต้องมั้ยถ้ามีบรรทัดที่เป็นช่องเปล่าๆ
```
