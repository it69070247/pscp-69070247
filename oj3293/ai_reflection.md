...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3293 - [LEARNING LOGS] BigFrame |
| OJ submission ID, if submitted | 655580 |
| OJ status | Pass |
...
```text
ทำไม len(str) ถึงนับตัวอักษรเกิน
```
...
```text
อาจมีช่องว่าง หรือ เว้นวรรคที่เรามองไม่เห็น ลองใช้ strip เพื่อลบเว้นวรรคที่มองไม่เห็น
```
...
```text
อาจจะมีบางโจทย์ที่input เป็นข้อความเยอะๆ การใช้ strip() ช่วยแก้ปัญหาเรื่องนี้ได้โดยการลบเว้นวรรคที่เราไม่รู้ออกทำให้การนับตัวอักษรแม่นยำ
```
