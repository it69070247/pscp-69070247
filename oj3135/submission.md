...
```text
โจทย์ให้ฉันนับคนที่checkของขวัญในการวนจนกลับมาคนที่1 1ครั้ง หรือพอถึงขโมย

Input:
บรรทัดเดียว มีคนทั้งหมด checkข้ามไปกี่คน เลขขโมย

Output:
จำนวนคนที่checkของขวัญรวมขโมย

Constraints:
input ทั้งหมดอยู่ในบรรทัดเดียว
```
...
```text
Step 1: รับค่าNKT
Step 2: สร้างตัวแปลไว้นับ
Step 3: for loop นับคนโดยใช้ if เมื่อไปคนถัดไปให้+1 ถ้าโดนขโมย+1แล้วหยุดลูป
Step 4: printจำนวนคน
```
...
Step 1: รับค่าNKT
Step 2: สร้างตัวแปลไว้นับ
Step 3: สร้างเงื่อนไขถ้า ขโมยคือคนแรก
Step 4: for loop นับคนโดยใช้ if เมื่อไปคนถัดไปให้+1 ถ้าโดนขโมย+1แล้วหยุดลูป
Step 5: printจำนวนคน
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้าNเยอะๆ
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้าขโมยคือคนแรก
```
