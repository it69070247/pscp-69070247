...
```text
โจทย์ให้รับคำใบ้เป็นชื่อย่อไพ่ แล้วให้แสดงออกมาเป็นชื่อเต็ม
...
Constraints:
inputมีทั้งstrและintในบรรทัดเดียวกัน
```
...
```text
Step 1: รับinput
Step 2: สร้าง list และ table ชื่อไ่พ่
Step 3: ตั้งเงื่อนไขถ้าเป็นตัวย่อตามในlistหรือtable
Step 4: ให้ print ชื่อเต็มของไพ่
```
...
```text
checkว่าทำงานถูกต้องมั้ยถ้าเป็นเลข
```
...
```text
checkว่าทำงานถูกต้องมั้ยถ้าเป็นเลข10
```
