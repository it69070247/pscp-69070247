...
| OJ submission ID, if submitted | 638925 |
| OJ status | Pass |
...
```text
ทำไมมันถึงนับ 9 ด้วยทั้งที่ 9 หารลงตัว
```
...
```text
โครงสร้าง if else ผิดระดับความลึก
```
...
```text
การใช้elseที่ตรงกับ for loop ทำให้ else จะทำงานก็ต่อเมื่อfor loop ทำงานครบโดยไม่โดนbreak
```
