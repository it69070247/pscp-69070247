...
| OJ submission ID, if submitted | 559004 |
| OJ status | Pass |
...
```text
check code ให้หน่อยว่าทำไมบางtestcaseยังไม่ผ่าน
```
...
```text
เงื่อนไขที่ตั้งไม่ละเอียดตรงวันที่21
```
...
```text
ฉันตรวจสอบ if แล้วสร้าง list เพิ่ม
```
...
```text
การใช้ list และ if เพื่อให้เงื่อนไขละเอียดมากขึ้น
```
