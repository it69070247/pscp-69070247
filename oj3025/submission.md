...
```text
โจทย์ให้รับค่าวันเดือน แล้วบอกว่าเป็น season อะไร
Input:
รับค่า เลขวัน และ เลขเดือน
Output:
print winter ถ้าinputเป็น 1 21

Constraints:ตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัว ต้องเปลี่ยนเป็นseasonถัดไป
```
...
Step 2: ตั้งเงื่อนไข ว่าเดือนนี้เป็นseasonนี้
Step 3: ถ้าจริง ให้พิมพ์ season ที่กำหนด
```
...
```text
Step 1: รับค่าวัน เดือน
Step 2: สร้าง list season และ วันตั้งแต่21
Step 3: ตั้งเงื่อนไข ว่าเดือนนี้เป็นseasonนี้
Step 4: ถ้าจริง ให้พิมพ์ season ที่กำหนด
```
