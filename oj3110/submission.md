...
```text
โจทย์ให้ฉันคำนวณค่าขนส่งพัสดุ

Input:
บรรทัดที่ 1 ต้นทาง ปลายทาง เป็น ภาษาอังกฤษตัวพิมพ์ใหญ่
บรรทัดที่ 2 น้ำหนักพัสดุ

Output:
บรรทัดที่ 1 ราคา

Constraints:
ถ้าเส้นทางไม่อยู่ในตารางให้ print Error
```
...
```text
Step 1: รับค่าต้นทางปลายทางและน้ำหนัก
Step 2: ตั้งเงื่อนไขคิดราคา
Step 3: print ราคา
Step 4: ถ้าไม่อยู่ในเงื่อนไข print Error
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้าน้ำหนักเยอะ
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้าปลายทางไม่อยู่ในเงื่อนไข
```
