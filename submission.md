...
```text
โจทย์ให้ฉันผสมสีจากแม่สี2สี

Input:
2 บรรทัด เป็นชื่อสี 

Output:
1 บรรทัด เป็นชื่อสี หรือ Error

Constraints:
ถ้าinputเป็นสีอื่นนอกจากแม่สีให้แสดง Error
```
...
Step 2: ตั้งเงื่อนไข
Step 3: หากเอาสีแดง มาผสมกับสีเหลืองให้แสดง สีส้ม
หากเอาสีแดง มาผสมกับสีน้ำเงิน ให้แสดงสีม่วง
หากเอาสีเหลือง มาผสมกับสีน้ำเงิน ให้แสดงสีเขียว
Step 4: นอกเหนือจากนี้ให้แสดง Error
```
...
```text
Step 1: รับค่าข้อความ
Step 2:สร้างlist แม่สี
Step 2: ตั้งเงื่อนไข หากinput ไม่ใช่ในlistให้แสดง Error
Step 4: หากเอาสีแดง มาผสมกับสีเหลืองให้แสดง สีส้ม
หากเอาสีแดง มาผสมกับสีน้ำเงิน ให้แสดงสีม่วง
หากเอาสีเหลือง มาผสมกับสีน้ำเงิน ให้แสดงสีเขียว
```
...
```text
check ว่าถ้าผสมสีออกมาจะถูกต้องมั้ย
```
...
```text
check ว่าถ้าinputสลับกันจะผสมสีออกมาจะถูกต้องมั้ย
```
...
```text
check ว่าถ้าinputไม่ใช่แม่สีจะprint Error มั้ย
```
