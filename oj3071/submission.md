...
```text
โจทย์ให้หาคำตอบจาก input ที่ใส่เข้ามา

Input:
บรรทัดที่ 1 จํานวนนับ A 
บรรทัดที่ 2 จํานวนนับ B
บรรทัดที่ 3 จํานวนนับ d
บรรทัดที่ 4 จํานวนนับ r

Output:
บรรทัดที่ 1 : คำตอบว่ามีจํานวนนับในช่วงA-Bกี่จํานวน ที่หารด้วยจํานวนนับ d แล้วเหลือเศษ r
```
...
Step 2: สร้างตัวแปร COUNT ไว้นับจำนวน
Step 3: for loop หาจำนวนที่หารdแล้วเหลือเศษr
Step 4: print COUNT
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้าห่างกันเยอะ
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้าห่างกันน้อย
```
