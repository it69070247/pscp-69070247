...
เมื่อโหวดกันเสร็จแล้ว ระบบจะแสดงเพียงคะแนนรวม และคะแนนสูงสุดเพียงค่าเดียว

ถ้าคะแนนโหวดของคนที่ให้คะแนนสูงและคะแนนต่ำสุดห่างกันเกินสองคะแนน จะทำให้คนมาดูคะแนนรู้สึกประหลาดใจ (Surprising)

Surprising ถ้ามีโอกาส
Not surprising ถ้าไม่มีโอกาส

Input:
รับคะแนนรวมและคะแนนสูงสุด
...
```text
Step 1: รับค่าเป็น float
Step 2: หาค่าที่เหลือ
Step 3: หาค่าน้อยสุด
Step 4: ตั้งเงื่อนไขถ้าคะแนนสูงสุด-ต่ำสุดมากว่า2
Step 5: Print Surprising ถ้ามีโอกาส Not surprising ถ้าไม่มีโอกาส
```
...
```text
checkว่าโค้ดทำงานถูกมั้ยโดยเปลี่ยนเลข
```
