...
| OJ submission ID, if submitted | 571367 |
| OJ status | Pass |
...
```text
มีสูตรหาค่าน้อยสุด โดยรู้แค่ผลรวมกับค่าสูงสุดมั้ย
```
...
```text
หาไม่ได้ตรงๆและอธิิบายว่าเป็นไปได้หลายแบบ
```
...
```text
ตรวจสอบโจทย์ตรงคำว่า "โอกาส" แล้วใช้maxเพื่อหาค่ามากสุด ของค่ามากสุดที่เป็นไปได้ 
```
