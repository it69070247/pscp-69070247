...
```text
โจทย์ให้รับค่าN แล้วบอกว่ามีจำนวนไหนบ้างตั้งแต่N-0ที่หารด้วย10ลงตัว

Input:
จำนวนเต็มN

Output:
จำนวนเต็มบวกตั้งแต่ N-0 ที่หารด้วย 10 ลงตัว
...
```text
Step 1: รับค่าn
Step 2: หาตัวแรกที่หารด้วย10ลงตัว
Step 3: for loop (ตัวแรกที่หารด้วย10ลงตัว , -10 ,-10)
Step 4: printจะนวนทั้งหมดในบรรทัดเดียวกัน
```
...
```text
check ว่าเรียงจากมากไปน้อยรึยัง
```
...
```text
check ว่าเริ่มที่จำนวนแรกที่หาร10ลงตัวหรือไม่
```
...
```text
check ว่าอยู่บรรทัดเดียวกันหรือไม่
```
