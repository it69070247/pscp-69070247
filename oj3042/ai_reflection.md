...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3042 - [LEARNING LOGS] หาร 10 |
| OJ submission ID, if submitted | 558179 |
| OJ status | Pass |
...
```text
มีวิธีprintค่าในloopให้อยู่ในบรรทัดเดียวกันมั้ย
```
...
```text
end= สามารถทำให้อยู่ในบรรทัดเดียวกันได้
```
