...
```text
โจทย์ให้ฉันคำนวณราคา

Input:
บรรทัดที่ 1 ตัวอักษรหนึ่งตัว
บรรทัดที่ 2 จํานวนเต็ม n
บรรทัดที่ 3 ราคาสินค้าที่ซื้อ

Output:
บรรทัดที่ 1 ราคารวม

Constraints:
output เป็น ทศนิยม 2 ตําแหน่ง
```
...
```text
Step 1: รับค่า
Step 2: for loop รับราคา
Step 3: ตั้งเงื่อนไขคำนวณราคา
Step 4: print ราคา
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้าราคาเกิน500
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้าเป็นYราคาเกิน500
```
