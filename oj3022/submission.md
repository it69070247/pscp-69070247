...
```text
โจทย์ให้เขียนโปรแกรมรับค่าอุณหภูมิจากหน่วยหนึ่งไปเป็นอีกหน่วยหนึ่ง ตามที่ได้กำหนดไว้
...
```text
Step 1: รับค่าอุณหภูมิ และ หน่วยแรกและหน่วยที่2
Step 2: ตั้งเงื่อนไขเปลี่ยนหน่วยอุณหภูมิ
Step 3: ใช้สูตรทางคณิตแปลงทุกหน่วย
Step 4: print อุณหภูมิที่เปลี่ยนหน่วยแล้ว
```
...
```text
Step 1: รับค่าอุณหภูมิ และ หน่วยแรกและหน่วยที่2
Step 2: แปลงทุกหน่วยเป็น C
Step 2: ตั้งเงื่อนไขเปลี่ยนหน่วยอุณหภูมิ
Step 3: ใช้สูตรทางคณิตแปลงหน่วยจากรูปที่ได้มา
Step 4: print อุณหภูมิที่เปลี่ยนหน่วยแล้ว
```
...
```text
check ว่าโค้ดทำงานถูกต้องใช้หน่วยอื่นๆ
```
