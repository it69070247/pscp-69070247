...
| OJ submission ID, if submitted | 566354 |
| OJ status | Pass |
...
```text
Too many branches แก้ยังไงได้บ้าง
```
...
```text
เปลี่ยนเงื่อนไขโดยเปลี่ยนทุกหน่วยเป็น C แล้วค่อยแปลงหน่วย
```
...
```text
รู้วิฑีการใหม่ๆที่ทำให้ code สั้นลง
```
