...
| OJ submission ID, if submitted | 597496 |
| OJ status | Pass |
...
```text
มีเงื่อนไขที่ซับซ้อนและไม่ละเอียด
```
...
```text
ฉันกลับไปใช้การคำนวณก่อนแล้วค่อยตั้งเงื่อนไข
```
...
```text
การคำนวณก่อนตั้งเงื่อนไขก็ช่วยทำให้code clean และดีขึ้นด้วยในบางข้อ
```
