...
```text
โจทย์ให้ฉันคำนวนหาอิฐก้อนเล็กว่าใช้น้อยสุดเท่าไหร่

Input:
บรรทัดที่ 1: ตัวแปร a ก้อนเล็ก
บรรทัดที่ 2: ตัวแปร b ก้อนใหญ่
บรรทัดที่ 3: ตัวแปร goal ความยาวสะพาน

Output:
จำนวนอิฐก้อนเล็กที่น้อยที่สุด

Constraints:
ถ้าสร้างไม่ได้ ตอบ -1
```
...
```text
Step 1: รับค่า a b goal
Step 2: ตั้งเงื่อนไขที่สะพานจะสร้างไม่ได้
Step 3: ถ้าสร้างสะพานไม่ได้ print -1
Step 4: ถ้าได้คํานวณว่าใช้เท่าไหร่
Step 5: หาก้อนใหญ่ก่อน แล้วค่อยหาก้อนเล็ก
```
...
```text
Step 1: รับค่า a b goal
Step 2: หาก้อนใหญ่ก่อน แล้วค่อยหาก้อนเล็ก
Step 3: ถ้าสร้างสะพานไม่ได้ print -1
Step 4: ถ้าได้ print ก้อนเล็ก
```
...
```text
checkว่าโปรแกรมทำงานถูกต้้องมั้ย
```
...
```text
check ว่าถ้า a เป็น 0 จะคิดถูกมั้ย
```
...
```text
check ว่าถ้า b เป็น 0 จะคิดถูกมั้ย
```
