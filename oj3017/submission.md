...
```text
โจทย์ให้ฉันรับค่าราคาอาหารแล้วคิดค่าที่ต้องจ่ายทั้งหมด

Input:
บรรทัดที่ 1 : จำนวนเงินรวมเฉพาะค่าอาหารและเครื่องดื่มที่ลูกค้าได้สั่งไป (จำนวนเต็ม)

Output:
บรรทัดที่ 1 : ผลรวมที่ลูกค้าต้องชำระเงินหลังจากได้รวมค่าบริการและ VAT 7% เรียบร้อยแล้ว (ให้แสดงเป็นจำนวนจริงทศนิยม 2 หลัก)

Constraints:
ค่าบริการเริ่มต้นที่50และมากสุดที่1000 outputเป็นทศนิยม2ตำแหน่ง
...
Step 1: รับค่าราคา
Step 2: คิดค่าบริการ
Step 3: ตั้งเงื่อนไขค่าบริการ
Step 4: ถ้าราคาน้อยกว่า500
Step 5: ค่าบริการ = 50
Step 6: ถ้าราคามากกว่า10000
Step 7: ค่าบริการ = 1000
Step 8: คิดvat
Step 9: เอาทุกอย่างมาบวกกันแล้ว print
```
...
```text
check ว่าprintออกมาเป็นทศนิยม2ตำแหน่งมั้ย
```
