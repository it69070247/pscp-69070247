...
```text
โจทย์ให้ฉันรับข้อความที่มีความยาว 5 อักขระ โดยอักษรตัวสุดท้ายจะเป็นอักษรตัวแรกของอักขระสับเปลี่ยน และอักษรตัวถัดไปจะสับเปลี่ยนจากด้านหลังไปด้านหน้าตามลำดับ ผลลัพธ์ที่พิมพ์ออกมาควรแปลงเป็นตัวพิมพ์เล็ก
...
Constraints:
output ต้องเป็นตัวพิมพ์เล็ก และต้องกลับด้าน
```
...
```text
Step 1: รับค่าข้อความ
Step 2: แสดงเป็นตัวพิมพ์เล็ก
Step 3: กลับด้านข้อความ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้input รับค่าข้อความแล้ว print ด้วย lower แล้วกลับด้านด้วย ::-1
```
...
```text
เพื่อทดสอบว่าข้อความกลับด้านหรือไม่
```
...
```text
เพื่อทดสอบว่าข้อความแสดงเป็นตัวพิมพ์เล็กหรือไม่
```
...
```text
เพื่อทดสอบว่าถ้ามีตัวพิมพ์ใหญ่เพิ่มข้อความแสดงเป็นตัวพิมพ์เล็กหรือไม่
```
