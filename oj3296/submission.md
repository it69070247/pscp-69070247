...
```text
โจทย์ให้ฉันผสมสี2สี เป็นตัวเลข

Input:
รับจำนวนเต็มในบรรทัดเดียวกันเป็นค่าสี แดง เขียว น้ำเงิน เป็น สีที่1 และสีที่2อีกบรรทัด

Output:
เป็นค่าสีที่ผสมแล้วบรรทัดเดียวคั่นด้วยเว้นวรรค

Constraints:
input เป็นจำนวนเต็มบรรทัดเดียวคั่นด้วยเว้นวรรค
```
...
```text
Step 1: รับค่าสองรอบ โดยใช้ map
Step 2: นำมาบวกกันแล้วหารสอง
Step 3: printคำตอบ
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้าเป็น0ทั้งหมด
```
...
```text
check ว่าทำงานถูกต้องมั้ยถ้าเป็น255ทั้งหมด
```
