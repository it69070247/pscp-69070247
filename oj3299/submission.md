...
```text
โจทย์ให้ฉันหาว่าดอกไม้ดอกสุดท้ายอยู่ในแถบที่เท่าไหร่

Input:
รับค่าเป็นจำนวนเต็ม 2 ค่า

Output:
แถบของดอกไม้ดอกสุดท้าย

Constraints:
input เป็นจำนวนเต็ม 2 ค่า อยู่ในบรรทัดเดียวกันคั่นด้วยเว้นวรรค
```
...
```text
Step 1: รับค่าโดยใช้ map(int, input().split())
Step 2: สร้างตัวแปรใช้คำนวณ
Step 3: for loop หาว่าแถบแรกปลูกไปกี่ดอก
Step 4: สร้างตัวแปรใช้คำนวณต่อ
Step 5: for loop นับแถว
Step 6: ตั้งเงื่อนไขถ้าดอกไม้ดอกสุดท้ายที่ปลูกในแถบนั้นๆน้อยกว่าดอกสุดท้ายให้นับต่อ
Step 7: ถ้าดอกไม้ดอกสุดท้ายที่ปลูกในแถบนั้นๆมากกว่าหรือเท่ากับดอกสุกท้ายให้หยุดนับ
Step 8: printค่าสุดท้ายของแถบ
```
...
```text
check ว่าทำงานถูกมั้ยถ้าดอกไม้ดอกสุดท้ายอยู่ในแถบแรก
```
...
```text
check ว่าทำงานถูกมั้ยถ้าดอกไม้ดอกสุดท้ายเป็นดอกแรกของแถบที่สอง
```
