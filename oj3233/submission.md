...
```text
โจทย์ให้ฉันตอบว่ารางวัลที่ได้กี่บาทจากเลขที่ซื้ัอและเลขที่ออก

Input:
เลขที่ออก มีตัวอักษรและเลขขั้นด้วยเว้นวรรค
เลขที่ซื้อ มีตัวอักษรและเลขขั้นด้วยเว้นวรรค

Output:
เงินรางวัลที่ได้

Constraints:
inputขั้นด้วยเว้นวรรค
...
```text
Step 1: รับinput 2บรรทัด
Step 2: ตั้งเงื่อนไข
Step 3: ถ้าเลขตรงให้เงินรางวัลตามที่กำหนด ถ้าไม่ตรงเลยไม่ได้เงินรางวัลหรือเงินรางวัลเป็น0
Step 4: printเงินรางวัล
```
...
```text
checkว่าทำงานภูกต้องมั้ยถ้าตรงแค่2ตัวท้าย
```
...
```text
checkว่าทำงานภูกต้องมั้ยถ้าไม่ตรงเลย
```
